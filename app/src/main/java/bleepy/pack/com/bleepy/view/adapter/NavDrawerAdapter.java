...
/**
 * Created by Siranjeevi on 12-06-18.
 */
...
public class NavDrawerAdapter extends BaseAdapter {
    ...
    public NavDrawerAdapter(ArrayList<String> options, TypedArray mImageArray) {
        this.mOptions = options;
        this.mTypedImageArray=mImageArray;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        optionView.bind(option, mTypedImageArray.getDrawable(position), null);
